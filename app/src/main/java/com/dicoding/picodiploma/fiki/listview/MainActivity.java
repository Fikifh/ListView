package com.dicoding.picodiploma.fiki.listview;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String[] dataName1 = {"Cut Nyak Dien","Ki Hajar Dewantara","Moh Yamin","Patimura","R A Kartini","Soekarno"};
    ...
    private void addItem() {
        ...
        for (int i = 0; i < dataName.length; i++) {
            Hero hero = new Hero();
            hero.setFoto(dataPhoto.getResourceId(i, -1));
